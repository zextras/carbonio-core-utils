...
createSchemaDir() {
  ...
  chown zextras:zextras "/opt/zextras/data/ldap/config/cn=config/cn=schema"
...
installCoreSchema() {
  ...
  chown zextras:zextras "/opt/zextras/data/ldap/config/cn=config/cn=schema/cn={0}core.ldif"
...
installInetOrgPersonSchema() {
  ...
  chown zextras:zextras "/opt/zextras/data/ldap/config/cn=config/cn=schema/cn={2}inetorgperson.ldif"
...
installDynlistSchema() {
  ...
  chown zextras:zextras "/opt/zextras/data/ldap/config/cn=config/cn=schema/cn={3}dyngroup.ldif"
...
installZimbraSchema() {
  ...
  chown zextras:zextras "/opt/zextras/data/ldap/config/cn=config/cn=schema/cn={4}carbonio.ldif"
...
installAmavisSchema() {
  ...
  chown zextras:zextras "/opt/zextras/data/ldap/config/cn=config/cn=schema/cn={5}amavisd.ldif"
...
installOpenDKIMSchema() {
  ...
  chown zextras:zextras "/opt/zextras/data/ldap/config/cn=config/cn=schema/cn={6}opendkim.ldif"
